...
import com.online.taxi.security.RSA256PublicJWTAccessToken;
...
public class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {
    ...
    @Value("${spring.oauth2.resource.id:oauth2-resource}")
    private String resourceId;

    @Bean
    public TokenStore tokenStore() throws IOException {
        //JWT令牌存储方案
        return new JwtTokenStore(new RSA256PublicJWTAccessToken());
    }
