...
//
//import com.online.taxi.domain.security.GrantType;
//import com.online.taxi.domain.security.Scope;
...
// **/
////@Named
//public class OAuthClientDetailsMemoryService implements ClientDetailsService {
//
//    /**
//     * 客户端模型
//     */
...
//            new Client("party", "party_secret", new String[]{GrantType.CLIENT_CREDENTIALS}, new String[]{Scope.SERVICE}),
//            new Client("order", "order_secret", new String[]{GrantType.CLIENT_CREDENTIALS}, new String[]{Scope.SERVICE}),
//            new Client("wallet", "wallet_secret", new String[]{GrantType.CLIENT_CREDENTIALS}, new String[]{Scope.SERVICE}),
//            new Client("valuation", "valuation_secret", new String[]{GrantType.CLIENT_CREDENTIALS}, new String[]{Scope.SERVICE}),
